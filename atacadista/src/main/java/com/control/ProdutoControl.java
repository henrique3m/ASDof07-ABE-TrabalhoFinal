...
//
//@RestController
//@RequestMapping("/solicitacao/{id}/itemSolicitacao/{idItem}")
...
//	@RequestMapping(method = RequestMethod.GET, value ="/getProduto")
...
//			if (p.getCod() == cod){
//				if (!p.hasLinks()){
//					p.add(linkTo(methodOn(ProdutoControl.class).GetProduto(cod)).withSelfRel());
//				}
//				prod = p;
//			}
//			
